...
# SPOILER_TITLE
locale_pt.spoiler_title = 'Revelar'
...
# SPOILER_MESSAGE
locale_pt.spoiler_message = 'Mensagem pública revelada.'
...
locale_pt.group_greeting_message = (
        ...
        '<a href="t.me/bl4ckoutgroup">comunidade pública</a> se você tiver alguma dúvida.')
...
locale_pt.info_message = (
        ...
        '👥 Bate-papo público: @bl4ckoutgroup\n'
        '⚙ Suporte: @BL4CKOUTassistent_bot')
...
locale_pt.too_long_description = 'Reduza o comprimento da sua mensagem para que não exceda o limite de 200 caracteres.'
